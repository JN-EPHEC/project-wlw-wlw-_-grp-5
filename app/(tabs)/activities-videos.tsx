...
export default function ActivitiesVideosScreen() {
  ...
  const openYoutube = (youtubeId: string) => {
    ...
    // Use ExternalLink to open in-app when possible
    return (
...
const styles = StyleSheet.create({
  ...
  grid: { gap: 12 },
  card: { backgroundColor: 'white', borderRadius: 12, padding: 15, shadowColor: '#000', shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.08, shadowRadius: 2, elevation: 2 },
  ...
  startButton: { backgroundColor: '#4f46e5', paddingHorizontal: 14, paddingVertical: 8, borderRadius: 18 },
  startButtonText: { color: 'white', fontWeight: '600' },
  videoCard: { flexDirection: 'row', backgroundColor: 'white', borderRadius: 12, overflow: 'hidden', shadowColor: '#000', shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.08, shadowRadius: 2, elevation: 2 },
  thumbnail: { width: 120, height: 80 },
  videoContent: { flex: 1, padding: 12, justifyContent: 'space-between' },
  videoTitle: { fontSize: 15, fontWeight: '700', color: '#111827' },
  videoDesc: { color: '#6b7280' },
  videoActions: { flexDirection: 'row', alignItems: 'center', marginTop: 8 },
  openButton: { backgroundColor: '#10b981', paddingHorizontal: 12, paddingVertical: 6, borderRadius: 16 },
  openButtonText: { color: 'white', fontWeight: '600' },
  videoFav: { marginLeft: 12 },
  tip: { marginTop: 16, backgroundColor: 'white', borderRadius: 12, padding: 15 },
